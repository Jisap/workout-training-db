  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-20 md:py-32 lg:py-40 bg-gradient-to-b from-background to-slate-50 dark:from-background dark:to-slate-900/80">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-slate-100 to-slate-200/60 dark:from-primary/10 dark:to-slate-900/50">
